...
public class BlankFragment1 extends Fragment implements StaffAttendanceAdapter.StaffAttendanceAdapterOnClickHandler{
    ...
    public BlankFragment1 newInstance(int sectionNumber, Context mContext1) {
