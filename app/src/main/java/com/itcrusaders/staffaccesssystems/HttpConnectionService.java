...
public class HttpConnectionService {
    ...
    public HttpConnectionService(Context context){
    ...
    public String sendRequest(String path, HashMap<String, String> params) {
        try {
            ...
            //Toast.makeText(mContext,"HttpConnectionService!. Problem in getting connection.",Toast.LENGTH_LONG).show();
            //ioe.printStackTrace();
        } catch (Exception e) {
            Log.d("HttpConnectionService", "Problem in getting connection. Safegaurd catch.");
            //Toast.makeText(mContext,"HttpConnectionService!. Problem in getting connection. Safegaurd catch.",Toast.LENGTH_LONG).show();
            //e.printStackTrace();
        }
        ...
        try {
            ...
            Log.d("HttpConnectionService", e.toString());
            //Log.d(mContext.getPackageName(),"Problem in getting outputstream and passing parameter.");
            //e.printStackTrace();
        }
    ...
    private String getPostDataString(HashMap<String, String> params) throws UnsupportedEncodingException {
        ...
        try {
            ...
            Log.d("HttpConnectionService", "Problem in getPostDataString while handling params."+e.toString());
