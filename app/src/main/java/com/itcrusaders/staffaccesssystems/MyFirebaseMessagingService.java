...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        try {
            ...
            String appoin = remoteMessage.getData().get("appoin");
            ...
            Intent intent = new Intent(this, VisitorCalendarActivity.class);
            intent.putExtra("appId", appId);
            intent.putExtra("appoin", appoin);
...
// notificationId is a unique int for each notification that you must define
    ...
    private void doSendBroadcast(String message) {
        ...
        if (!TextUtils.isEmpty(message))
            it.putExtra("snackbarMessage",message);
    ...
    private void sendRegistrationToServer(String token) {
        ...
        FireBaseTokenManipulator fireBaseTokenManipulator = new FireBaseTokenManipulator();
        fireBaseTokenManipulator.saveTokenOnline(this,token);
    }
